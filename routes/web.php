...
Route::group(['namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'admin', "middleware"=>"admin"], function () {
    ...
    Route::group(['namespace' => 'GrupaKultur',"prefix"=>"grupa_kultur"], function () {
        Route::get('/', 'IndexController')->name('admin.grupa_kultur.index');
        Route::get('/create', 'CreateController')->name('admin.grupa_kultur.create');
        Route::post('/', 'StoreController')->name('admin.grupa_kultur.store');
        Route::get('/{grupa_kultur}', 'ShowController')->name('admin.grupa_kultur.show');
        Route::get('/{grupa_kultur}/edit', 'EditController')->name('admin.grupa_kultur.edit');
